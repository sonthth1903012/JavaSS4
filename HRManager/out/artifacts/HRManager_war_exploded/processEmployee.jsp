...
<div class="content">
    <br><br>
    <jsp:useBean id="e" class="com.example.entities.Employee" scope="request"/>
    <jsp:useBean id="convert" class="com.example.ConvertData" scope="session"/>
    <table align="center" id="tb2">
        ...
        <form name="frmEmployee" method="post" action="ProcessEmployee" onsubmit="javascript:return check_submit()">
            ...
            <tr>
                <td>Hire Date:</td>
                <td><input type="date" name="txtHireDate"></td>
