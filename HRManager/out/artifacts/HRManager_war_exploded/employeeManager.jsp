        ...
        <div class="content">
            ...
            if (arr.length > 0) {
                for (int i = 0; i < arr.length; i++) {
                    ...
                    out.println("<td align='center'><a href='ProcessEmployee?action=edit&id=" + arr[i].getID() + "'>Edit </a></td>");
                    out.println("<td align='center'><a href='ProcessEmployee?action=delete&id=" + arr[i].getID() + "'> Delete</a></td></tr>");
                }
            }
                %>
            </table>
