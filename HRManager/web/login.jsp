...
<div class="header">
    ...
    <div class="menu bubplastic horizontal orange">
        <ul>
            ...
            <li><span class="menu_r"><a href="employeeManager.jsp"><span class="menu_ar">Product List</span></a></span>
            </li>
...
<div class="content">
    ...
    %>
    <jsp:useBean id="valid" class="com.example.ValidData" scope="session"/>
